    ...
    <div className="h-[calc(100vh-8rem)] flex flex-col items-center justify-center bg-black-100 text-white px-4">
      ...
      >
        <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <motion.circle
            cx="60" cy="60" r="30"
            stroke="#fff" strokeWidth="4" strokeDasharray="8 8"
            initial={{ rotate: 0 }}
            animate={{ rotate: 360 }}
      ...
      <Link href="/" className="mt-4 px-6 py-3 bg-violet-450 text-white font-semibold rounded-lg shadow hover:bg-violet-700 transition-colors">
        Go Home
      </Link>
    </div>
  );
