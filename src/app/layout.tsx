...
export const metadata: Metadata = {
  ...
  description: "Showcasing a journey through code, creativity, and clean design — all in one place.",
  keywords: ["web development", "Next.js", "React", "JavaScript", "TypeScript", "programming", "portfolio", "Hemanth Babu S"],
