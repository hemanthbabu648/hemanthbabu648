...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center pt-20 pb-16 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-[var(--accent-purple)] rounded-full blur-[150px] opacity-20" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-[var(--accent-cyan)] rounded-full blur-[180px] opacity-10" />

      <div className="max-w-6xl mx-auto px-4 w-full relative z-10">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          {/* Left: Text Content */}
          <div className="order-2 md:order-1">
            <p className="text-[var(--accent-purple)] text-sm font-medium mb-2 tracking-wider">
              Hi, I&apos;m
            </p>
            ...
            <p className="text-[var(--text-secondary)] mb-8 text-base md:text-lg leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link
                ...
                target="_blank"
                className="btn-secondary px-5 py-2.5 rounded-lg flex items-center gap-2 hover:scale-105 transition-transform"
              >
                <Download size={18} />
                Download Resume
              </Link>
          ...
          <div className="relative order-1 md:order-2 flex justify-center">
            <div className="relative">
              {/* Glow Behind Image */}
              <div className="absolute inset-0 bg-gradient-to-br from-[var(--accent-purple)] to-[var(--accent-cyan)] rounded-lg blur-2xl opacity-30 scale-120" />
              ...
              {/* Decorative Border */}
              <div className="absolute inset-0 border-2 border-[var(--accent-purple)] rounded-lg translate-x-4 translate-y-4 -z-10 border-glow" />
