...
export default function ContactCard({
  ...
  const getAccentClasses = (color: 'purple' | 'cyan') => {
    if (color === 'purple') {
      return {
        bg: 'hover:bg-[var(--np-accent-purple)]/10',
        border: 'hover:border-[var(--np-accent-purple)]/30',
        iconBg: 'bg-[var(--np-accent-purple)]/10 group-hover/link:bg-[var(--np-accent-purple)]/20',
        iconColor: 'text-[var(--np-accent-purple)]',
      };
    }
    return {
      bg: 'hover:bg-[var(--np-accent-cyan)]/10',
      border: 'hover:border-[var(--np-accent-cyan)]/30',
      iconBg: 'bg-[var(--np-accent-cyan)]/10 group-hover/link:bg-[var(--np-accent-cyan)]/20',
      iconColor: 'text-[var(--np-accent-cyan)]',
    };
  };
      ...
      <div className="relative bg-[var(--np-bg-secondary)]/80 backdrop-blur-sm rounded-xl p-6 border border-[var(--np-border-muted)] group-hover:border-[var(--np-accent-purple)]/50 transition-colors">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-[var(--np-text-muted)] text-xs">{subtitle}</p>
          </div>
        </div>
            ...
            return (
              <li key={link.href}>
                <a
                  ...
                  className={`flex items-center gap-4 p-3 rounded-lg bg-[var(--np-bg-tertiary)]/50 ${accent.bg} border border-transparent ${accent.border} transition-all group/link`}
                >
                  <div
                  ...
                  <div>
                    ...
                    <p className="text-[var(--np-text-secondary)] text-xs">{link.handle}</p>
                  </div>
                </a>
              </li>
            );
